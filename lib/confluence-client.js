...
class ConfluenceClient {
   ...
   * @param {string} newParentId - The ID of the new parent page
   * @param {string} newTitle - Optional new title for the page
  ...
  async movePage(pageId, newParentId, newTitle = null) {
    ...
    const currentContent = currentPage.data.body.storage.value;
    const spaceKey = currentPage.data.space.key;
