...
class MacroConverter {
  constructor({ isCloud = false, webUrlPrefix = '', buildUrl = null, linkStyle = null, plantumlFormat = null } = {}) {
    ...
    this.plantumlFormat = resolvePlantumlFormat({ plantumlFormat });
  ...
  htmlToConfluenceStorage(html) {
    return htmlToStorage(html, {
      ...
      plantumlFormat: this.plantumlFormat,
    });
  }
